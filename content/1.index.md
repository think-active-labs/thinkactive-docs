...
navTitle: 'Home'
---
# ThinkActive Documentation :icon{name="line-md:document-code" size="10" class="text-indigo-600"}
...
::list
- [Learn more about ThinkActive Cloud](/thinkactive-cloud) and how to integrate with our cloud platform :book:
- Dive into our engineering documentation for [building applications using ActiveBand](/developing-for-activeband) :icon{name="line-md:construction-twotone" class="text-yellow-400"}
- [Learn about ThinkActive Sync App](/thinkactive-sync-app) and get help diagnosing sync and setup errors :icon{name="line-md:cloud-up-twotone" class="text-emerald-400"}
- [Get help using our supported ActiveBand devices](/using-activeband) :icon{name="line-md:alert"} 
